...
const tab = ref<'users' | 'tags'>('users');
...
const tagForm = reactive({ name: '', color: '#f3eee8', description: '', displayOrder: 0 });
...
<template>
  <section class="page">
    ...
    <article v-if="tab === 'users'" class="panel">
      <h2>新增用户</h2>
      <div class="form-grid">
    ...
    <article v-else class="panel">
      ...
      <div class="form-grid">
        ...
        <input v-model="tagForm.color" placeholder="#f3eee8" />
...
.row:hover {
  border-color: rgba(38, 30, 24, 0.2);

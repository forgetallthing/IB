...
import QuestionImportExportView from './views/QuestionImportExportView.vue';
...
const routes = [
  ...
  { path: '/questions/io', component: QuestionImportExportView },
...
router.beforeEach((to) => {
  ...
  if (to.path === '/settings' && authStore.user?.role !== 'admin') {
    return { path: '/questions' };
  }
